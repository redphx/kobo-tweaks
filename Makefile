...
override MOCS     += src/tweaks.h src/patches.h src/utils.h src/settings/settings.h src/widgets/battery_widget.h src/widgets/clock_widget.h src/widgets/book_title_widget.h src/widgets/elided_label.h src/hooks/reading_view.h

...
override SOURCES  += src/tweaks.cc src/common.cc src/resources.qrc.cpp src/patches.cc src/utils.cc src/settings/settings.cc src/debug_utils.cc src/hooks/reading_view.cc
